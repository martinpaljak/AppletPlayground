...
public class MuscleApplet extends javacard.framework.Applet implements ExtendedLength {
	...
	private MuscleApplet(byte[] bArray, short bOffset, byte bLength) {
		// FIXME: something should be done already here, not only with setup APDU
	}

	public static void install(byte[] bArray, short bOffset, byte bLength) {
		MuscleApplet wal = new MuscleApplet(bArray, bOffset, bLength);

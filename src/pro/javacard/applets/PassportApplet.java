...
public class PassportApplet extends Applet implements ISO7816 {
	...
	private PassportFileSystem fileSystem;
	...
	private void processCreateFile(APDU apdu) {
		...
		if(fid == PassportFileSystem.EF_CVCA_FID) {
